...
Eventaually, probably within a nanosecond, the remove(...) call that update the old `AtomicInteger` to 0 would remove the `AtomicInteger` that having 0 from the map.
